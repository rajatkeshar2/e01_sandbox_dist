...
function deconstruct(e) {
    var r = 0,
        t = null;
    for (var o in e)
        if (t = [o, e[o]], ++r > 1) throw new Error("Multi k-v deconstruct not supported");
...
var SmartDB = function() {
    function e(r) {
        (0, _classCallCheck3.default)(this, e), this.app = r, this.trsLogs = new Array, this.blockLogs = new Array, this.lockCache = new _set2.default, this.indexes = new _map2.default, this.indexSchema = new _map2.default
    }
    return (0, _createClass3.default)(e, [{
        ...
        key: "rollbackBlock",
        value: function() {
            this.lockCache.clear(), this.rollbackTransaction(), this.undoLogs(this.blockLogs)
        }
    }, {
        key: "commitBlock",
        value: function() {
            var e = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function e(r) {
                ...
                return _regenerator2.default.wrap(function(e) {
                    for (;;) switch (e.prev = e.next) {
                        case 0:
                            if (r = r || {}, this.trsLogs.length > 0 && this.commitTransaction(), app.logger.trace("enter commitBlock"), 100, t = [], o = [], n = 0, this.blockLogs.forEach(function(e) {
                                    n % 100 == 0 && 0 !== o.length && (t.push(o), o = []);
                                    var r = (0, _toArray3.default)(e),
                                        a = r[0],
                                        i = r.slice(1);
                        ...
                        case 11:
                            ...
                            return e.next = 16, this.app.db.transaction();
                        case 16:
                            a = e.sent;
                        case 17:
                            e.t0 = _regenerator2.default.keys(t);
                        case 18:
                            if ((e.t1 = e.t0()).done) {
                                e.next = 26;
                                break
                            }
                            return i = e.t1.value, s = t[i].join(""), app.logger.debug("execute sql:", s), e.next = 24, this.app.db.query(s);
                        case 24:
                            e.next = 18;
                            break;
                        case 26:
                            ...
                            return e.next = 29, a.commit();
                        case 29:
                            this.blockLogs = new Array, this.lockCache.clear(), e.next = 40;
                            break;
                        case 33:
                            if (e.prev = 33, e.t2 = e.catch(12), app.logger.error("-!!!!!!!!!!!!!!!!!!!!!!commit error", e.t2), r.noTransaction) {
                                e.next = 39;
                                break
                            }
                            return e.next = 39, a.rollback();
                        case 39:
        ...
        value: function() {
            this.blockLogs = this.blockLogs.concat(this.trsLogs), this.trsLogs = new Array
        }
    }, {
        key: "load",
        value: function() {
            var e = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function e(r, t, o) {
                var n, a, i;
                return _regenerator2.default.wrap(function(e) {
                    for (;;) switch (e.prev = e.next) {
                        case 0:
                            return n = this.app, e.next = 3, n.model[r].findAll({
                                fields: t
                            });
                        case 3:
                            a = e.sent, i = new _map2.default, a.forEach(function(e) {
                            ...
                            }), this.indexes.set(r, i), this.indexSchema.set(r, {
                                fields: t,
                                indexes: o
                            });
                        case 8:
        ...
        value: function(e) {
            ...
            this.trsLogs.push(["Lock", e]), this.lockCache.add(e)
        }
    }, {
        key: "undoLock",
        value: function(e) {
        ...
        value: function(e, r) {
            var t = this.indexes.get(e),
                o = this.indexSchema.get(e);
            if (t && o)
                for (var n in r) o.indexes.forEach(function(e) {
                    var o = fromIndexSchemaToToken(e, r);
                    t.delete(o)
                })
        }
        ...
        value: function(e, r) {
            ...
            if (t && o) {
                ...
                var i = fromIndexSchemaToToken(o.indexes[0], r),
                    s = t.get(i);
                s && this.trsLogs[this.trsLogs.length - 1].push(s), t.set(i, r)
            }
        }
    }, {
        key: "undoReplace",
