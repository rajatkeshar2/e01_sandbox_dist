...
var private_ = {},
    ...
    TransactionPool = function() {
        function e() {
            (0, _classCallCheck3.default)(this, e), this.index = new _map2.default, this.unConfirmed = new Array
        }
        return (0, _createClass3.default)(e, [{
            key: "add",
            value: function(e) {
                this.unConfirmed.push(e), this.index.set(e.id, this.unConfirmed.length - 1)
            }
        }, {
            key: "remove",
            value: function(e) {
                var r = this.index.get(e);
                delete this.index[e], this.unConfirmed[r] = null
            }
        }, {
            key: "has",
            value: function(e) {
            ...
            key: "clear",
            value: function() {
                this.index = new _map2.default, this.unConfirmed = new Array
            }
        }, {
            key: "get",
            value: function(e) {
...
function Transactions(e, r) {
    library = r, (self = this).pool = new TransactionPool, e(null, self)
}
Transactions.prototype.getUnconfirmedTransaction = function(e) {
    ...
    var e = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function e(r) {
        ...
        return _regenerator2.default.wrap(function(e) {
            for (;;) switch (e.prev = e.next) {
                ...
                case 15:
                    return e.next = 17, app.model.Transaction.exists({
                        id: r.id
                    });
                case 17:
                    if (!e.sent) {
                ...
                case 20:
                    return r.senderId || (r.senderId = modules.blockchain.accounts.generateAddressByPublicKey(r.senderPublicKey)), a = modules.blockchain.blocks.getLastBlock().height, o = {
                        height: a,
                        delegate: modules.blockchain.round.getCurrentDelegate(a)
                    }, e.prev = 23, e.next = 26, modules.logic.transaction.apply(r, o);
                case 26:
                    e.next = 32;
                    break;
                case 28:
                    throw e.prev = 28, e.t0 = e.catch(23), app.sdb.rollbackTransaction(), new Error("Apply transaction error: " + e.t0);
                case 32:
                    return self.pool.add(r), e.abrupt("return", r);
                case 34:
                case "end":
                    return e.stop()
            }
        ...
        (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function r() {
            ...
            return _regenerator2.default.wrap(function(r) {
                for (;;) switch (r.prev = r.next) {
                    case 0:
                        return r.prev = 0, r.next = 3, self.processUnconfirmedTransactionAsync(t.transaction);
                    case 3:
                        n = r.sent, e(null, {
                            transactionId: n.id
                        }), r.next = 10;
                        break;
                    case 7:
                        r.prev = 7, r.t0 = r.catch(0), e(r.t0.toString());
                    case 10:
                    case "end":
                        return r.stop()
                }
    ...
    if (t.type && (t.type = Number(t.type)), !library.validator.validate(t, {
        ...
        })) return (0, _setImmediate3.default)(r, library.validator.getLastError().details[0].message);
    library.sequence.add(function(e) {
        (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function r() {
            var n, a;
            return _regenerator2.default.wrap(function(r) {
                for (;;) switch (r.prev = r.next) {
                    case 0:
                        return r.prev = 0, n = modules.api.crypto.keypair(t.secret), a = modules.logic.transaction.create(t, n), r.next = 5, self.processUnconfirmedTransactionAsync(a);
                    case 5:
                        e(null, {
                            transactionId: a.id
                        }), r.next = 11;
                        break;
                    case 8:
                        r.prev = 8, r.t0 = r.catch(0), e(r.t0.toString());
                    case 11:
                    case "end":
                        return r.stop()
                }
...
}, Transactions.prototype.getUnconfirmedTransactions = function(e, r) {
    (0, _setImmediate3.default)(r, null, {
    ...
    var t = this,
        ...
        o = {};
    e.query.senderId && (o.senderId = e.query.senderId), e.query.type && (o.type = Number(e.query.type)), (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function e() {
        var s, i;
        return _regenerator2.default.wrap(function(e) {
            for (;;) switch (e.prev = e.next) {
                case 0:
                    return e.prev = 0, e.next = 3, app.model.Transaction.count(o);
                case 3:
                    return s = e.sent, e.next = 6, app.model.Transaction.findAll({
                        condition: o,
                        limit: n,
                        offset: a
                    });
                case 6:
                    return (i = e.sent) || (i = []), e.abrupt("return", r(null, {
                        transactions: i,
                        count: s
                    }));
                case 11:
                    return e.prev = 11, e.t0 = e.catch(0), app.logger.error("Failed to get transactions", e.t0), e.abrupt("return", r("System error: " + e.t0));
                case 15:
                case "end":
                    return e.stop()
            }
...
}, Transactions.prototype.getTransaction = function(e, r) {
    (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function t() {
        var n, a;
        return _regenerator2.default.wrap(function(t) {
            for (;;) switch (t.prev = t.next) {
                ...
                case 3:
                    return n = e.params.id, t.next = 6, app.model.Transaction.findOne({
                        condition: {
                            id: n
                        }
                    });
                ...
                case 12:
                    return t.prev = 12, t.t0 = t.catch(0), t.abrupt("return", r("System error: " + t.t0));
                case 15:
                case "end":
                    return t.stop()
            }
...
}, Transactions.prototype.receiveTransactions = function(e, r) {
    (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function t() {
        var n;
        return _regenerator2.default.wrap(function(t) {
            for (;;) switch (t.prev = t.next) {
                ...
                case 2:
                    ...
                    return t.next = 5, self.processUnconfirmedTransactionAsync(e[n]);
                case 5:
                    ++n, t.next = 2;
                    break;
                case 8:
        ...
        return _regenerator2.default.wrap(function(e) {
            for (;;) switch (e.prev = e.next) {
                ...
                case 1:
                    ...
                    return e.next = 4, self.processUnconfirmedTransactionAsync(r[t]);
                case 4:
                    ++t, e.next = 1;
                    break;
                case 7:
    ...
    switch (e.topic) {
        case "transaction":
            library.sequence.add(function(r) {
                var t = e.message;
                self.receiveTransactions([t], function(e) {
