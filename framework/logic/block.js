...
private_.types = {}, Block.prototype.getBytes = function(e, t) {
    var r = new ByteBuffer(1, !0);
    r.writeString(e.prevBlockId || "0"), r.writeLong(e.height), r.writeInt(e.timestamp), r.writeInt(e.payloadLength);
    ...
    if (r.writeString(e.pointId || "0"), r.writeLong(e.pointHeight || 0), r.writeInt(e.count), !t && e.signature)
        for (a = new Buffer(e.signature, "hex"), o = 0; o < a.length; o++) r.writeByte(a[o]);
    return r.flip(), r.toBuffer()
