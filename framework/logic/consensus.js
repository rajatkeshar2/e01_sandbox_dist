...
function Consensus(e, t) {
    library = t, this.pendingBlock = null, this.pendingVotes = null, this.votesKeySet = {}, e && (0, _setImmediate3.default)(e, null, this)
}
Consensus.prototype.createVotes = function(e, t) {
    ...
    return r.writeLong(e), r.writeString(t), r.flip(), crypto.createHash("sha256").update(r.toBuffer()).digest()
    ...
    this.pendingVotes = null, this.votesKeySet = {}, this.pendingBlock = e
}, Consensus.prototype.clearState = function() {
    this.pendingVotes = null, this.votesKeySet = {}, this.pendingBlock = null
    ...
    return s.hash = n.toString("hex"), s.signature = ed.Sign(n, e).toString("hex"), s
}, Consensus.prototype.getProposeHash = function(e) {
    var t = new ByteBuffer;
    t.writeLong(e.height), t.writeString(e.id);
    ...
    return assert(2 == n.length), t.writeInt(ip.toLong(n[0])), t.writeInt(Number(n[1])), t.flip(), crypto.createHash("sha256").update(t.toBuffer()).digest()
    ...
    if (e.hash != t.toString("hex")) return app.logger.warn("Propose hash is not correct"), !1;
    try {
        ...
        return app.logger.debug("Verify signature exception: ", e), !1
    }
