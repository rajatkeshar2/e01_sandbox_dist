...
module.exports = {
    deposit: function() {
        var e = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function e(r, t, n, a) {
            return _regenerator2.default.wrap(function(e) {
                for (;;) switch (e.prev = e.next) {
                    ...
                    case 5:
                        return e.next = 7, app.model.Deposit.exists({
                            srcId: n
                        });
                    case 7:
                        if (!e.sent) {
                    ...
                    case 10:
                        app.sdb.lock("core.deposit@" + n), app.balances.increase(a, r, t), app.sdb.create("Deposit", {
                            tid: this.trs.id,
                            currency: r,
                            amount: t,
                            srcId: n,
    ...
    transfer: function() {
        var e = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function e(r, t, n) {
            var a;
            return _regenerator2.default.wrap(function(e) {
                for (;;) switch (e.prev = e.next) {
                    case 0:
                    ...
                    case 2:
                        ...
                        return e.abrupt("return", "Insufficient balance");
                    case 6:
                        app.balances.transfer(r, t, this.trs.senderId, n), app.sdb.create("Transfer", {
                            tid: this.trs.id,
        ...
        var e = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function e(r) {
            ...
            return _regenerator2.default.wrap(function(e) {
                for (;;) switch (e.prev = e.next) {
                    ...
                    case 2:
                        return app.sdb.lock("core.account@" + this.trs.senderId), e.next = 5, app.model.Account.exists({
                            str1: r
                        });
                    case 5:
                        if (!e.sent) {
                    ...
                    case 8:
                        ...
                        }, e.next = 11, app.model.Account.findOne({
                            condition: t
                        });
                    case 11:
                        if (!(n = e.sent) || !n.str1) {
